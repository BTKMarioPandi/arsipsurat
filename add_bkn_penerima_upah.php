					...
					<div class="row blog-page">
						<div class="col-md-12 blog-box">
							<div class="post-content">
								<h1 align="center">ARSIP BUKAN PENERIMA UPAH</h1>
								<div class="container">
								...
								<div class="row">
									<div class="col-xs-12">
										<form enctype="multipart/form-data" action="proses_add_bkn_penerima_upah.php" method="POST">
											<div class="form-group row">
												<div class="col-xs-3">
													<label>Tanggal Bulan</label>
													<input type="date" class="form-control" name="tgl_bulan">
												</div>
												<div class="col-xs-3">
													<label>Tahun</label>
												...
												<div class="col-xs-3">
													<label>NPW Nomor Mitra NIK</label>
													<input type="text" class="form-control" name="npw_no_mitra_nik">
												</div>
												<div class="col-xs-3">
													<label>Nama Wadah Mitra Individu</label>
													<input type="text" class="form-control" name="nama_wadah_mitra_individu">
												</div>
												<div class="col-xs-3">
